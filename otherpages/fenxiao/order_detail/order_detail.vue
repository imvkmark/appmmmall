		...
		<view>
			<view class="order-detail">
				<view class="order-detail-box">
					<view class="header">
						<view class="title ns-bg-before">
							<text>订单明细</text>
						</view>
						<text class="ns-text-color" v-if="orderData.is_refund==1">已退款</text>
						<text class="ns-text-color" v-else-if="orderData.is_settlement==1">已结算</text>
						<text class="ns-text-color" v-else>待结算</text>
					</view>
					<view class="detail-body">
						<view class="detail-body-box">
							<view class="goods-image">
								<image :src="$util.img(orderData.sku_image, { size: 'mid' })" @error="imageError(goodsIndex)" mode="aspectFill"></image>
							</view>
							<view class="order-info">
								<view class="goods-name">{{ orderData.sku_name }}</view>
								<view class="goods-sub-section ns-margin-top">
									<view>
					...
					<view class="detail-content">
						...
						<view class="order-info-item">
							...
							<text class="ns-text-color">￥{{orderData.commission}}</text>
						</view>
					</view>
					<view class="detail-footer">
						...
						<text>
							<text>合计：</text>
							<text class="ns-text-color">￥{{orderData.real_goods_money}}</text>
						</text>
					</view>
				</view>
			</view>
