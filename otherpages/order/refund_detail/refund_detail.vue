			...
			<view v-show="action == ''">
				<view class="status-wrap">
					...
					<view class="refund-explain" v-if="detail.refund_status == 1">
						<view class="ns-font-size-sm ns-text-color-gray">如果商家拒绝，你可重新发起申请</view>
						<view class="ns-font-size-sm ns-text-color-gray">如果商家同意，将通过申请并退款给你</view>
						<view class="ns-font-size-sm ns-text-color-gray">如果商家逾期未处理，平台将自动通过申请并退款给你</view>
					</view>
					<view class="refund-explain" v-if="detail.refund_status == 5">
						<view class="ns-font-size-sm ns-text-color-gray">如果商家确认收货将会退款给你</view>
						<view class="ns-font-size-sm ns-text-color-gray">如果商家拒绝收货，该次退款将会关闭，你可以重新发起退款</view>
					</view>
				</view>
				...
				<view class="return-goods-container">
					<view class="form-wrap">
						<view class="item">
							...
							<view class="cont">
								<input type="text" value="" placeholder="请输入物流公司" class="input" placeholder-class="input-placeholder ns-text-color-gray"
						...
						<view class="item">
							...
							<view class="cont">
								<input type="text" value="" placeholder="请输入物流单号" class="input" placeholder-class="input-placeholder ns-text-color-gray"
						...
						<view class="item">
							...
							<view class="cont">
								<textarea value="" placeholder-class="ns-text-color-gray ns-font-size-base" :auto-height="true" class="textarea"
