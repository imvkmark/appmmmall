<template>
	<view class="container">
		...
		<view class="coin-section m-t">
			<empty text="暂无订单记录" :show="empty" mode="data" margin-top="200"></empty>
		...
		<uni-popup ref="popup" type="top">
			<view class="filter-wrapper">
				<view class="filter">
					...
					<view class="filter-pay">
						<text class="filter-pay-item" v-for="(v, k) in statusMap" :key="k" @click="filter(undefined, k)" :class="{ 'filter-active': query.status == k }">
							{{ v }}
						</text>
					</view>
				</view>
