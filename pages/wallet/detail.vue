		...
		<view class="list">
			...
			<view class="coin-section">
				<view class="block">
					...
					<scroll-view style="background-color:#FFFFFF;" class="s-list" :enableBackToTop="enableBackToTop" :scroll-y="scrollY" @scrolltolower="loadMore">
						<empty text="暂无记录" :show="empty" mode="data" margin-top="10"></empty>
...
<script>
	...
	export default {
		...
		onLoad() {
			this.currentStatusMap = this.withdrawStatusMap	//前面测试用，后面删除
		},
		onShow(){
			this.coin = 'ETH'
