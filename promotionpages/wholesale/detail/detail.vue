	...
	<view :class="themeStyle">
		<view class="goods-detail">
			...
			<view class="goods-container">
				...
				<view class="group-wrap">
					<view class="goods-module-wrap ns-padding-top">
						<view>
						...
						<view class="goods-module-wrap-box">
							<view class="wholeSale-price">
								<view class="price">
									...
									<text class="price ns-text-color">{{ goodsSkuDetail.min_price }}</text>
								</view>
								<view class="startNumber">
									{{goodsSkuDetail.min_num}}件起批
								</view>
							</view>
						</view>
					</view>
				...
				<!-- SKU选择 -->
				<ns-goods-sku-whole-sale ref="goodsSku" @refresh="refreshGoodsSkuDetail" :goods-detail="goodsSkuDetail"></ns-goods-sku-whole-sale>
		...
		<ns-goods-action>
			<template v-if="goodsSkuDetail.goods_state == 1 && goodsSkuDetail.verify_state == 1">
				...
				<ns-goods-action-icon text="进货单" icon="icongouwuche" :corner-mark="wholeSaleNumber > 0 ? wholeSaleNumber + '' : ''" @click="goCart" />
				<ns-goods-action-button class="goods-action-button" :class="goodsSkuDetail.is_virtual == 0 ? 'active1' : ''" text="加入进货单"
				 background="linear-gradient(to right, #ffd01e, #ff8917)" @click="joinCart" v-if="goodsSkuDetail.is_virtual == 0" />
...
<script>
	...
	import nsGoodsSkuWholeSale from '@/components/ns-goods-sku/ns-goods-sku-wholesale.vue';
...
<style scoped>
	...
	/deep/ .uni-center .uni-popup__wrapper-box{
