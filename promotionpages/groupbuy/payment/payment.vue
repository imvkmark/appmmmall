		...
		<uni-popup ref="sitePromotionPopup" type="bottom">
			<view class="promotion-popup popup">
				...
				<scroll-view scroll-y="true" class="popup-body">
					<view>
						<view class="order-cell">
							<text class="tit"><text class="promotion-mark ns-gradient-promotionpages-topics-payment" :class="themeStyle">团购</text></text>
							<view class="box align-right">
								团购{{ orderPaymentData.groupbuy_info.buy_num }}件起,享团购价<text class="ns-text-color">{{ orderPaymentData.groupbuy_info.groupbuy_price }}</text>元
							</view>
						</view>
					</view>
				</scroll-view>
