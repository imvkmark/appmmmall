<template>
	<view class="order-container" :class="themeStyle">
		...
		<view class="order-checkout" v-if="orderPaymentData.member_account.balance_total > 0">
			...
			<view class="order-cell">
				<text class="tit">优惠券</text>
				<view class="box align-right" @click="openPopup('couponPopup')">
					<text class="ns-text-color-gray">无可用</text>
				</view>
				<text class="iconfont iconright"></text>
			</view> -->
		</view>
		...
		<uni-popup ref="sitePromotionPopup" type="bottom">
			<view class="promotion-popup popup">
				...
				<scroll-view scroll-y="true" class="popup-body">
					<view>
						<view class="order-cell">
							<text class="tit"><text class="promotion-mark ns-gradient-promotionpages-topics-payment" :class="themeStyle">限时秒杀</text></text>
							<view class="box align-right"></view>
						</view>
					</view>
				</scroll-view>
