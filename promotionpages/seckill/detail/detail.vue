...
<!-- 播放视频 -->
				...
				<view class="seckill-wrap" v-if="goodsSkuDetail.discountTimeMachine">
					<text class="iconfont iconxianshimiaosha"></text>
				...
				<view class="group-wrap">
					...
					<view class="goods-module-wrap">
						<view class="price-wrap">
							<view class="seckill-price ns-text-color">
								<text class="symbol">{{ $lang('common.currencySymbol') }}</text>
								<text class="price">{{ goodsSkuDetail.seckill_price }}</text>
							</view>
							<view class="original-price">
								<text class="price">{{ $lang('common.currencySymbol') }} {{ goodsSkuDetail.price }}</text>
								<text class="seckill-save-price">秒杀立省{{ $lang('common.currencySymbol') }}{{ goodsSkuDetail.save_price }}</text>
							</view>
							<view class="sale-num ns-text-color">已抢：{{ goodsSkuDetail.sale_num }}{{ goodsSkuDetail.unit }}</view>
						</view>
					</view>
				</view>
...
export default {
	...
	onShareAppMessage(res) {
		var path = '/promotionpages/seckill/detail/detail?id=' + this.id;
...
.seckill-wrap .countdown .clockrun >>> .uni-countdown__number {
	min-width: 32rpx;
	height: 32rpx;
	text-align: center;
	line-height: 32rpx;
...
.seckill-wrap .countdown .clockrun >>> .uni-countdown__splitor {
	height: 32rpx;
	line-height: 36rpx;
	text-align: center;
	display: inline-block;
...
.seckill-wrap .countdown .clockrun >>> .uni-countdown__splitor.day {
	width: initial;
}
