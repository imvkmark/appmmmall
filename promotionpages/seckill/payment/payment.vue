		...
		<view class="site-wrap">
			...
			<view class="site-footer">
				...
				<view class="order-cell">
					...
					<view class="box text-overflow" @click="openSitePromotion"><text class="ns-text-color-gray">限时秒杀</text></view>
					<text class="iconfont iconright"></text>
				</view>
				<view class="order-cell">
			...
			<view class="promotion-popup popup">
				...
				<scroll-view scroll-y="true" class="popup-body">
					<view>
						<view class="order-cell">
							<text class="tit">
								<text class="promotion-mark ns-gradient-promotionpages-topics-payment" :class="themeStyle">限时秒杀</text>
								{{ orderPaymentData.seckill_info.name }}
							</text>
							<view class="box align-right"></view>
						</view>
					</view>
